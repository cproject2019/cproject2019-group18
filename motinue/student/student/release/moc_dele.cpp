...
const QMetaObject dele::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_dele.data,
      qt_meta_data_dele,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *dele::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_dele.stringdata0))
        return static_cast<void*>(const_cast< dele*>(this));
